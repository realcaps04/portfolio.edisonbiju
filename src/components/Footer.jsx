...
const SOCIALS = [
  ...
  {
    label: 'Discord',
    href: 'https://discord.gg/msRyDp3hg',
    icon: (
      ...
      <div className="footer__inner">
        <div className="footer__top">
          ...
          <div className="footer__brand">
            <a href="#home" className="footer__logo font-gropled">EDISON</a>
          ...
          <div className="footer__contact">
            ...
            <a href="mailto:edisonbijumullappallil@gmail.com" className="footer__email">
